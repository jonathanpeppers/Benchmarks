...
{
	public sealed class Binding2 : BindingBase
	{
		internal const string SelfPath = ".";
		IValueConverter _converter;
		object _converterParameter;

		BindingExpression2 _expression;
		string _path;
		object _source;
		...
		public Binding2(string path, BindingMode mode = BindingMode.Default, IValueConverter converter = null, object converterParameter = null, string stringFormat = null, object source = null)
		{
			if (path == null)
		...
		public string Path
		{
			...
			set
			{
				...
				_path = value;
				_expression = new BindingExpression2(this, !string.IsNullOrWhiteSpace(value) ? value : SelfPath);
			}
		}
		...
		internal override void Apply(bool fromTarget)
		{
			...
			if (_expression == null)
				_expression = new BindingExpression2(this, SelfPath);
