...
using Benchmarks;
using Color = Xamarin.Forms.Color2;
...
namespace Xamarin.Forms
{
	...
	public struct Color2
	{
		...
		public Color2(double r, double g, double b, double a) : this(r, g, b, a, Mode.Rgb)
		{
		}

		Color2(double w, double x, double y, double z, Mode mode)
		{
			_mode = mode;
			switch (mode)
			{
				...
				case Mode.Default:
					...
					break;
				case Mode.Rgb:
					_r = (float)w.Clamp2(0, 1);
					_g = (float)x.Clamp2(0, 1);
					_b = (float)y.Clamp2(0, 1);
					_a = (float)z.Clamp2(0, 1);
					ConvertToHsl(_r, _g, _b, mode, out _hue, out _saturation, out _luminosity);
					break;
				case Mode.Hsl:
					_hue = (float)w.Clamp2(0, 1);
					_saturation = (float)x.Clamp2(0, 1);
					_luminosity = (float)y.Clamp2(0, 1);
					_a = (float)z.Clamp2(0, 1);
		...
		public Color2(double r, double g, double b) : this(r, g, b, 1)
		{
		}

		public Color2(double value) : this(value, value, value, 1)
		{
		}
