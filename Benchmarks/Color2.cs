...
using Benchmarks;
using Color = Xamarin.Forms.Color1;
...
namespace Xamarin.Forms
{
	...
	public struct Color1
	{
		...
		public Color1(double r, double g, double b, double a) : this(r, g, b, a, Mode.Rgb)
		{
		}

		Color1(double w, double x, double y, double z, Mode mode)
		{
			_mode = mode;
			switch (mode)
			{
				...
				case Mode.Default:
					...
					break;
				case Mode.Rgb:
					_r = (float)w.Clamp1(0, 1);
					_g = (float)x.Clamp1(0, 1);
					_b = (float)y.Clamp1(0, 1);
					_a = (float)z.Clamp1(0, 1);
					ConvertToHsl(_r, _g, _b, mode, out _hue, out _saturation, out _luminosity);
					break;
				case Mode.Hsl:
					_hue = (float)w.Clamp1(0, 1);
					_saturation = (float)x.Clamp1(0, 1);
					_luminosity = (float)y.Clamp1(0, 1);
					_a = (float)z.Clamp1(0, 1);
		...
		public Color1(double r, double g, double b) : this(r, g, b, 1)
		{
		}

		public Color1(double value) : this(value, value, value, 1)
		{
		}
